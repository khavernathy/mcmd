	...
	exit(EXIT_FAILURE);
        ...
        std::transform(lc[1].begin(), lc[1].end(), lc[1].begin(), ::tolower);
            ...
            // OR EXACT BASIS INPUT (by vectors)
                ...
                std::cout << "Got external force vector = [ " << lc[1].c_str() << ", " << lc[2].c_str() << ", " << lc[3].c_str() << " ] nanoNewtons every " << lc[4].c_str() << " steps."; printf("\n");
        ...
        std::transform(lc[1].begin(), lc[1].end(), lc[1].begin(), ::tolower);
                ...
                std::cout << "Got fragment-maker = on. Going to make " << lc[1] << " base fragments."; printf("\n");
                ...
                std::cout << "Got crystal-based forcefield option = " << lc[1].c_str(); printf("\n");
