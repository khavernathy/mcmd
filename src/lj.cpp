...
double lj(System &system) {
    ...
    system.stats.lj_lrc = total_rd_lrc; system.stats.current_lj_lrc_sum += total_rd_lrc;
    system.stats.lj_self_lrc = total_rd_self_lrc; system.stats.current_lj_self_lrc_sum += total_rd_self_lrc;
    system.stats.lj = total_lj; system.stats.current_lj_sum += total_lj;
